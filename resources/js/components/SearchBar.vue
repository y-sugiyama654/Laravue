<template>
    <div>
       ...
       <div class="relative z-10">
           ...
           <input class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100" type="text" placeholder="Search..." id="searchTerm" v-model="searchTerm" @input="search" @focus="focus = true">

       </div>
        <div v-if="focus" class="absolute bg-blue-900 text-white rounded-lg p-4 w-1/4 right-0 mr-6 mt-2 shadow z-20 ">
