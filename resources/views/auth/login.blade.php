...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-8">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div class="">
                    <input id="email" type="email" class="pt-8 w-full rounded pb-2 pl-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                ...
                <div class="">
                    <input id="password" type="password"  class="pt-8 w-full rounded pb-2 pl-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" required autocomplete="current-password" placeholder="Password">
