    ...
    <div class="w-1/4 bg-blue-900 rounded-lg shadow-xl p-8">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="relative pt-8">
                ...
                <div>
                    <input id="name" type="text" class="pt-8 w-full rounded pb-2 pl-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Your Name">
